      ...
      <svg id="logo-15" width="49" height="48" viewBox="0 0 49 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='links'>
          <ul id="navbars" className={clicked ? 'navbars active' : 'navbars'} onClick={() => setClicked(false)}>
            ...
            <li><Link to="/about" className={activeLink === 'about' ? 'active' : ''} onClick={() => handleClick('about')}>Sobre</Link></li>
            <li><Link to="/contact" className={activeLink === 'contact' ? 'active' : ''} onClick={() => handleClick('contact')}>contato</Link></li>
          </ul>         
        </div>
        <div id="mobile">
